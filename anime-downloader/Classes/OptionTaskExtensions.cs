...
{
    // https://github.com/nlkl/Optional/blob/master/src/Optional.Async/OptionTaskExtensions.cs
    public static class OptionTaskExtensions
    {
        ...
        public static async Task<Option<TResult>> MapAsync<T, TResult>(this Task<Option<T>> optionTask,
            Func<T, TResult> mapping, bool executeOnCapturedContext = false)
        {
        ...
        public static async Task<Option<TResult>> MapAsync<T, TResult>(this Task<Option<T>> optionTask,
            Func<T, Task<TResult>> mapping, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult>(this Option<T> option,
            Func<T, Task<Option<TResult>>> mapping)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult>(this Task<Option<T>> optionTask,
            Func<T, Option<TResult>> mapping, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult>(this Task<Option<T>> optionTask,
            Func<T, Task<Option<TResult>>> mapping, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult, TException>(this Option<T> option,
            Func<T, Task<Option<TResult, TException>>> mapping)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult, TException>(this Task<Option<T>> optionTask,
            Func<T, Option<TResult, TException>> mapping, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<TResult>> FlatMapAsync<T, TResult, TException>(this Task<Option<T>> optionTask,
            Func<T, Task<Option<TResult, TException>>> mapping, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        public static async Task<Option<T>> FilterAsync<T>(this Task<Option<T>> optionTask, Func<T, bool> predicate,
        ...
        public static async Task<Option<T>> FilterAsync<T>(this Task<Option<T>> optionTask,
            Func<T, Task<bool>> predicate, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (predicate == null) throw new ArgumentNullException(nameof(predicate));
        ...
        public static async Task<Option<T>> OrAsync<T>(this Task<Option<T>> optionTask, Func<T> alternativeFactory,
            bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (alternativeFactory == null) throw new ArgumentNullException(nameof(alternativeFactory));
        ...
        public static async Task<Option<T>> OrAsync<T>(this Task<Option<T>> optionTask,
            Func<Task<T>> alternativeFactory, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (alternativeFactory == null) throw new ArgumentNullException(nameof(alternativeFactory));
        ...
        public static async Task<Option<T>> ElseAsync<T>(this Option<T> option,
            Func<Task<Option<T>>> alternativeOptionFactory)
        {
        ...
        public static async Task<Option<T>> ElseAsync<T>(this Task<Option<T>> optionTask,
            Func<Option<T>> alternativeOptionFactory, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (alternativeOptionFactory == null) throw new ArgumentNullException(nameof(alternativeOptionFactory));
        ...
        public static async Task<Option<T>> ElseAsync<T>(this Task<Option<T>> optionTask,
            Func<Task<Option<T>>> alternativeOptionFactory, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (alternativeOptionFactory == null) throw new ArgumentNullException(nameof(alternativeOptionFactory));
        ...
        public static async Task<Option<T, TException>> WithExceptionAsync<T, TException>(this Option<T> option,
            Func<Task<TException>> exceptionFactory)
        {
            ...
            if (exceptionFactory == null)
                throw new InvalidOperationException($"{nameof(exceptionFactory)} must not return a null task.");
        ...
        public static async Task<Option<T, TException>> WithExceptionAsync<T, TException>(
            this Task<Option<T>> optionTask, Func<TException> exceptionFactory, bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (exceptionFactory == null) throw new ArgumentNullException(nameof(exceptionFactory));
        ...
        public static async Task<Option<T, TException>> WithExceptionAsync<T, TException>(
            this Task<Option<T>> optionTask, Func<Task<TException>> exceptionFactory,
            bool executeOnCapturedContext = false)
        {
            if (optionTask == null) throw new ArgumentNullException(nameof(optionTask));
            if (exceptionFactory == null) throw new ArgumentNullException(nameof(exceptionFactory));
